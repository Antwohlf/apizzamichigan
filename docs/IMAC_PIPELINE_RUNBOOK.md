...
```bash
ssh example-host 'cd /srv/apizzamichigan && node scripts/ops/verify-supabase-sync-policy.mjs'
```
...
```bash
ssh example-host 'cd /srv/apizzamichigan && node scripts/ops/verify-source-promotion-policy.mjs'
```
...
```bash
ssh example-host 'cd /srv/apizzamichigan && node scripts/ops/verify-source-matching-prefetch.mjs'
```
...
```bash
ssh example-host 'cd /srv/apizzamichigan && node scripts/ops/verify-atp-spider-manifest.mjs'
```
...
```bash
ssh example-host 'cd /srv/apizzamichigan && node scripts/ops/verify-source-input-adapters.mjs'
ssh example-host 'cd /srv/apizzamichigan && node scripts/ops/verify-fsq-sample-workflow.mjs'
ssh example-host 'cd /srv/apizzamichigan && node scripts/ops/verify-fsq-review-summary.mjs'
```
...
```bash
ssh example-host 'cd /srv/apizzamichigan && node scripts/ops/guarded-supabase-sync.mjs --ids 182432,182527 --insert-missing-reviewed-new'
ssh example-host 'cd /srv/apizzamichigan && node scripts/ops/guarded-supabase-sync.mjs --ids 182432,182527 --insert-missing-reviewed-new --apply'
```
