...
-- function applies one JSONB batch in one transaction and re-checks protected
-- classifier fields at write time so a concurrent writer cannot overwrite them.
