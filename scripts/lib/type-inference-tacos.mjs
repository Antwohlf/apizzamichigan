...
const CHAIN_TYPE_MAP = {
  ...
  'taco bell': { types: ['Ground Beef', 'Chicken'], price: '$' },
  'del taco': { types: ['Ground Beef', 'Chicken', 'Carne Asada'], price: '$' },
  'taco cabana': { types: ['Chicken', 'Carne Asada', 'Carnitas'], price: '$' },
  "taco john's": { types: ['Ground Beef', 'Chicken'], price: '$' },
  'taco johns': { types: ['Ground Beef', 'Chicken'], price: '$' },
  'taco bueno': { types: ['Ground Beef', 'Chicken'], price: '$' },
  'taco casa': { types: ['Ground Beef', 'Chicken'], price: '$' },
  'taco mayo': { types: ['Ground Beef', 'Chicken'], price: '$' },
  'taco time': { types: ['Ground Beef', 'Chicken'], price: '$' },
  ...
  "fuzzy's taco shop": { types: ['Ground Beef', 'Chicken', 'Fish'], price: '$$' },
  'fuzzys taco shop': { types: ['Ground Beef', 'Chicken', 'Fish'], price: '$$' },
  "torchy's tacos": { types: ['Carne Asada', 'Chicken', 'Fish'], price: '$$' },
  'torchys tacos': { types: ['Carne Asada', 'Chicken', 'Fish'], price: '$$' },
  'velvet taco': { types: ['Carne Asada', 'Chicken'], price: '$$' },
  'bartaco': { types: ['Carne Asada', 'Chicken', 'Fish'], price: '$$' },
  'tacodeli': { types: ['Carne Asada', 'Chicken', 'Barbacoa'], price: '$$' },
