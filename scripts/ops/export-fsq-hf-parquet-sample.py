...
def matches(row: dict[str, Any], args: argparse.Namespace) -> bool:
    ...
    if args.query and args.query.lower() not in name and "pizzeria" not in categories and "pizza" not in categories:
        return False
...
def main() -> int:
    ...
    print(
        ...
        f"--max-distance-m 100 --limit 5000 --sample 25 --review-output {args.review_output}"
    )
