...
const STATUS_OPTIONS = new Set(['accepted', 'linked', 'rejected', 'ignored', 'all']);
...
Options:
  ...
  --status <status|all>         Decision status to export
                                (default accepted)
...
This exports reviewed source_review_queue decisions only. It does not create
places, link place_sources, mutate canonical tables, or sync to Supabase.
`);
}
